...
import org.apache.hyracks.dataflow.std.sample.AbstractSampleOperatorDescriptor;
import org.apache.hyracks.dataflow.std.sample.FieldRangePartitionDelayComputerFactory;
import org.apache.hyracks.dataflow.std.sample.MaterializingForwardOperatorDescriptor;
import org.apache.hyracks.dataflow.std.sample.MaterializingSampleOperatorDescriptor;
import org.apache.hyracks.dataflow.std.sample.MergeSampleOperatorDescriptor;
import org.apache.hyracks.dataflow.std.sample.SampleAlgorithm;
import org.apache.hyracks.dataflow.std.sample.SampleConnectorPolicyAssignmentPolicy;
...
public class SampleForwardTest extends AbstractIntegrationTest {
    ...
    public void sampleForward_Merge() throws Exception {
        ...
        IOperatorDescriptor mergeSampleCust = new MergeSampleOperatorDescriptor(spec, 4, normalFields, outputRec, 4,
                sampleKeyFactories, sampleCmpFactories, SampleAlgorithm.ORDERED_SAMPLE, false);
