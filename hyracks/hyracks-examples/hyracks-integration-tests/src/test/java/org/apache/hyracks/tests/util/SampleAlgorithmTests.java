...
import org.apache.hyracks.dataflow.std.sample.DTStreamingHistogram;
import org.apache.hyracks.dataflow.std.sample.DualSerialEntry;
import org.apache.hyracks.dataflow.std.sample.IHistogram;
import org.apache.hyracks.dataflow.std.sample.SampleUtils;
import org.apache.hyracks.dataflow.std.sample.TernaryIterativeHistogram;
import org.apache.hyracks.dataflow.std.sample.IIterativeHistogram;
...
public class SampleAlgorithmTests extends TestCase {
    ...
    public void testIterativeTernaryHitogram() throws Exception {
        ...
        for (int i = 0; i < generated.size(); i++) {
            ...
            UTF8StringPointable.toString(sb, generated.get(i).getKey().getByteArray(), 0);
        ...
        if (fixPointable) {
            ...
            for (int i = 0; i < fixed.size(); i++) {
                StringBuilder sb = new StringBuilder();
                UTF8StringPointable.toString(sb, fixed.get(i).getKey().getByteArray(), 0);
        ...
        for (int i = 0; i < generated.size(); i++) {
            ...
            UTF8StringPointable.toString(lastString, generated.get(i).getKey().getByteArray(), 0);
