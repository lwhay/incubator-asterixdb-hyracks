...
public class TrieTests extends TestCase {
    ...
    public void testTernaryTrie() throws Exception {
        TernaryMemoryTrie<SequentialAccessor> tmt = new TernaryMemoryTrie<SequentialAccessor>(DEFAULT_TRIE_LIMIT,
                DEFAULT_SELF_GROW);
        BufferedReader br = new BufferedReader(new FileReader("/Users/michael/Desktop/tpch_2_16_1/dbgen/orders.tbl"));
        String line = null;
        while (null != (line = br.readLine())) {
            ...
            UTF8StringPointable.toString(sb, key.getByteArray(), 0);
