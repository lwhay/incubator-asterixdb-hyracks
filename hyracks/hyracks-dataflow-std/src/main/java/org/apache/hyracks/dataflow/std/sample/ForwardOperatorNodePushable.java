...
public class ForwardOperatorNodePushable extends AbstractUnaryInputUnaryOutputOperatorNodePushable {
    ...
    private SampledRangeMapTaskState sampleState;
    ...
    public void open() throws HyracksDataException {
        ctx.setGlobalState(partition, new SampledRangeMapTaskState(sampleDesc));
        sampleState = (SampledRangeMapTaskState) ctx.getGlobalState(partition);
