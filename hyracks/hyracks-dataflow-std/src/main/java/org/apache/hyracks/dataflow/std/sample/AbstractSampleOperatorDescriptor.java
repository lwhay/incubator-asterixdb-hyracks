...
public abstract class AbstractSampleOperatorDescriptor extends AbstractOperatorDescriptor {
    ...
    private final SampleAlgorithm alg;
    ...
    public AbstractSampleOperatorDescriptor(IOperatorDescriptorRegistry spec, int frameLimit, int[] sampleFields,
            int sampleBasis, RecordDescriptor rDesc, IBinaryComparatorFactory[] compFactories, SampleAlgorithm alg,
            int outputArity) {
    ...
    public AbstractSampleOperatorDescriptor(IOperatorDescriptorRegistry spec, int frameLimit, int[] sampleFields,
        ...
        if (null == alg)
            this.alg = SampleAlgorithm.ORDERED_SAMPLE;
        else
            this.alg = alg;
    }
