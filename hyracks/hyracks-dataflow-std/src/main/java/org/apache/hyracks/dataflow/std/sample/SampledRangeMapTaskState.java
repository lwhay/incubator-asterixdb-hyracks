 ...
 * @author michael
 */
public class SampledRangeMapTaskState implements IStateObject/*extends AbstractStateObject*/{
    private IHyracksTaskContext ctx;
    private RunFileWriter out;
    private final RecordDescriptor keyDesc;

    public SampledRangeMapTaskState(/*JobId jobId, Object taskId,*/RecordDescriptor keyDesc) {
        //        super(jobId, taskId);
    ...
    public void open(IHyracksTaskContext context) throws HyracksDataException {
        ...
        FileReference file = context.getJobletContext().createManagedWorkspaceFile(
                SampledRangeMapTaskState.class.getSimpleName());
